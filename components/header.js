                ...
                <div class="mobile-header-container">
                    ...
                    <div class="mobile-drop">
                        ...
                        <ul class="mobile-menu-list">
                            ...
                            <li><a href="#">온라인 도서관(myON)</a></li> <!-- (노션 안내 페이지로 연동) -->
                            <li><a href="#">입학상담 예약하기</a></li>


                            <li class="menu-title">안내 링크</li>
                            <li><a href="#">방학 특강 안내</a></li> <!-- (노션 안내 페이지로 연동) -->
                            <li><a href="#">온라인 도서관(myON) 안내</a></li> <!-- (노션 안내 페이지로 연동) -->
                            <li><a href="#">학원 소개서</a></li> <!-- (노션 안내 페이지로 연동) -->
